...
export const BorderBrandWidth = "$brand-border";
...
export const ShadowBrandBlur = "$brand-shadow";
export const ShadowBrandY = "$brand-shadow";
...
export const FontHeading = "$brand-typeface";
export const FontBody = "$brand-typeface";
export const RadiusBrand = "$brand-radius";
...
export const SpacingBrandPadding = "$brand-spacing";
export const SpacingBrandGap = "$brand-spacing";
